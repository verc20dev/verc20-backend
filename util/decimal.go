...
func NewDecimalFromBigInt(value *big.Int) *Decimal {
	return &Decimal{Value: new(big.Int).Set(value)}
}
...
// Mul multiplies two Decimal instances and returns a new Decimal instance
func (d *Decimal) Mul(other *Decimal) *Decimal {
	if d == nil || other == nil {
		return nil
	}
	value := new(big.Int).Mul(d.Value, other.Value)
	value = value.Div(value, precisionFactor)
	return &Decimal{Value: value}
}
